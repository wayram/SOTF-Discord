      ...
      <div className={styles.landingContent}>
        <div className={styles.landingLeft}>
          <div className={styles.text}>
            <img src={textLogo} alt="textlogo" loading="lazy" />
            ...
            <span>
              ...
              <Link to="/shop">Shop <i className='bx bxs-shopping-bag'></i></Link>
            </span>
          </div>
          <div className={styles.links}>
            <span>Total Members: {serverData.approximate_member_count}</span>
            <span>Discord Partner <img src="https://cdn3.emoji.gg/emojis/4902-partner.png" width="50px" height="50px" alt="Partner" loading="lazy"/></span>
            <span>Online Members: {serverData.approximate_presence_count}</span>
          </div>
        </div>
        <div className={styles.landingRight}>
          <img src={skull} alt="skull" loading="lazy" />
        </div>
      </div>
    </div>
  );
